...
from pyiron_atomistics.hamilton.murnaghan import Murnaghan, FitMurnaghan
...
class MurnaghanDFT(Murnaghan):
    ...
    def set_kpoints(self, mesh=None, scheme='MP', center_shift=None, symmetry_reduction=True, manual_kpoints=None,
        ...
        if self.ref_job:
            self._ref_job.set_kpoints(mesh=mesh, scheme=scheme, center_shift=center_shift,
                                      symmetry_reduction=symmetry_reduction, manual_kpoints=manual_kpoints,
