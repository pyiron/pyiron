...
class TestChildids(unittest.TestCase):
    ...
    def test_childids(self):
        ...
        ham_child_1_2.save()
        self.assertEqual(ham_master_1.child_ids, [ham_child_1_1.job_id, ham_child_1_2.job_id])
        ham_child_1_3 = self.project.create_job('ScriptJob', "child_1_3")
        ham_child_1_3.master_id = ham_master_1.job_id
        ham_child_1_3.save()
        self.assertEqual(ham_master_1.child_ids, [ham_child_1_1.job_id, ham_child_1_2.job_id, ham_child_1_3.job_id])
        ...
        ham_child_1_5.save()
        self.assertEqual(ham_master_1.child_ids, [ham_child_1_1.job_id, ham_child_1_2.job_id, ham_child_1_3.job_id,
                                                  ham_child_1_4.job_id, ham_child_1_5.job_id])
        ham_child_1_6 = self.project.create_job('ScriptJob', "child_1_6")
        ham_child_1_6.master_id = ham_master_1.job_id
        ham_child_1_6.save()
        self.assertEqual(ham_master_1.child_ids, [ham_child_1_1.job_id, ham_child_1_2.job_id, ham_child_1_3.job_id,
                                                  ham_child_1_4.job_id, ham_child_1_5.job_id, ham_child_1_6.job_id])
        ...
        self.assertEqual(ham_master_1.child_ids, [ham_child_1_1.job_id, ham_child_1_2.job_id, ham_child_1_3.job_id,
                                                  ham_child_1_4.job_id, ham_child_1_5.job_id, ham_child_1_6.job_id,
                                                  ham_child_1_7.job_id, ham_child_1_8.job_id])
        ham_child_1_9 = self.project.create_job('ScriptJob', "child_1_9")
        ham_child_1_9.master_id = ham_master_1.job_id
        ham_child_1_9.save()
        self.assertEqual(ham_master_1.child_ids, [ham_child_1_1.job_id, ham_child_1_2.job_id, ham_child_1_3.job_id,
                                                  ham_child_1_4.job_id, ham_child_1_5.job_id, ham_child_1_6.job_id,
                                                  ham_child_1_7.job_id, ham_child_1_8.job_id, ham_child_1_9.job_id])
        ...
        self.assertEqual(ham_master_1_reload.child_ids, [ham_child_1_1.job_id, ham_child_1_2.job_id,
                                                         ham_child_1_3.job_id, ham_child_1_4.job_id,
                                                         ham_child_1_5.job_id, ham_child_1_6.job_id,
                                                         ham_child_1_7.job_id, ham_child_1_8.job_id,
