...
class InteractiveLibrary(object):
    ...
    def command(self, command_in):
        self._command = command_in

    def _get_lib_command(self):
        return self._command

    def scatter_atoms(self, *args):
        self._command = ' '.join([str(arg) for arg in args])
...
class TestLammps(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.job._interactive_library = InteractiveLibrary()
    ...
    def test_interactive_cells_setter(self):
        ...
        self.assertEqual(self.job._interactive_library._get_lib_command(),
    ...
    def test_interactive_positions_setter(self):
        ...
        self.assertEqual(self.job._interactive_library._get_lib_command(), 'change_box all remap')
