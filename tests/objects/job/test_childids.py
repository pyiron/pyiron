...
class TestChildids(unittest.TestCase):
    ...
    def test_childids(self):
        ham_master_1 = self.project.create_job("ExampleJob", "master")
        ham_master_1.save()
        self.assertEqual(ham_master_1.job_id, 1)
        ham_child_1_1 = self.project.create_job("ExampleJob", "child_1_1")
        ...
        ham_child_1_2 = self.project.create_job("ExampleJob", "child_1_2")
        ...
        ham_child_1_3 = self.project.create_job("ExampleJob", "child_1_3")
        ...
        ham_child_1_4 = self.project.create_job("ExampleJob", "child_1_4")
        ...
        ham_child_1_5 = self.project.create_job("ExampleJob", "child_1_5")
        ...
        ham_child_1_6 = self.project.create_job("ExampleJob", "child_1_6")
        ...
        ham_child_1_7 = self.project.create_job("ExampleJob", "child_1_7")
        ...
        ham_child_1_8 = self.project.create_job("ExampleJob", "child_1_8")
        ...
        ham_child_1_9 = self.project.create_job("ExampleJob", "child_1_9")
        ...
        ham_master_2 = self.project.create_job("ExampleJob", "master_2")
        ham_master_2.save()
        self.assertEqual(ham_master_2.job_id, 11)
        ham_child_2_1 = self.project.create_job("ExampleJob", "child_2_1")
