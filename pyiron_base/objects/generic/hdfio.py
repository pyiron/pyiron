...
class FileHDFio(object):
    ...
    def __setitem__(self, key, value):
        ...
        elif isinstance(value, list) and len(value) > 0 and isinstance(value[0], list):  # multi dimension numpy arrays
...
class ProjectHDFio(FileHDFio):
    ...
    def create_hdf(self, path, job_name):
        """
        Create an ProjectHDFio object to store project related information - for pyiron_example_job aggregated data
