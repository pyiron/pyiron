...
from pyiron_atomistic.vasp.potential import VaspPotential, VaspPotentialFile, VaspPotentialSetter, Potcar, \
...
from pyiron_atomistic.vasp.oszicar import Oszicar
from pyiron_atomistic.vasp.procar import Procar
from pyiron_atomistic.vasp.structure import read_atoms, write_poscar, vasp_sorter
from pyiron_atomistic.vasp.vasprun import Vasprun as Vr
from pyiron_atomistic.vasp.vasprun import VasprunError, VasprunWarning
from pyiron_atomistic.vasp.volumetric_data import VaspVolumetricData
from pyiron_atomistic.vasp.potential import get_enmax_among_potentials
...
class VaspBase(GenericDFTJob):
    """
    Class to setup and run and analyze VASP simulations which is a derivative of pyiron_atomistic.objects.job.generic.GenericJob.
    ...
    Attributes:
        input (pyiron_atomistic.vasp.vasp.Input): Instance which handles the input
...
class Kpoints(GenericParameters):
    ...
    def load_default(self):
        ...
        """
        file_content = """\
Kpoints file generated with pyiron_atomistic
0
Monkhorst_Pack
4 4 4
0 0 0
