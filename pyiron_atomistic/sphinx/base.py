...
from pyiron_atomistic.vasp.potential import VaspPotentialFile, \
...
from pyiron_atomistic.sphinx.potential import SphinxJTHPotentialFile
from pyiron_atomistic.sphinx.potential import find_potential_file \
    as find_potential_file_jth
from pyiron_atomistic.sphinx.volumetric_data import SphinxVolumetricData
...
class SphinxBase(GenericDFTJob):
    ...
    Inherits pyiron_atomistic.atomistics.job.generic.GenericJob. The functions in
    ...
    def restart_for_band_structure_calculations(self, job_name=None):
        ...
        Returns:
            pyiron_atomistic.sphinx.sphinx.sphinx: new job instance
        """
    ...
    def get_charge_density(self):
        ...
        Returns:
            pyiron_atomistic.atomistics.volumetric.generic.VolumetricData
        """
