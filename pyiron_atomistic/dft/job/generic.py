...
import numpy as np
from pyiron_atomistic.atomistics.job.atomistic import AtomisticGenericJob, MapFunctions as AtomisticMapFunctions
...
class GenericDFTJob(AtomisticGenericJob):
    ...
    def restart_for_band_structure_calculations(self, job_name=None):
        ...
        Returns:
            new_ham (pyiron_atomistic.dft.job.generic.GenericDFTJob): New job
        """
        raise NotImplementedError(
    ...
    def get_electronic_structure(self):
        ...
        Returns:
                pyiron_atomistic.atomistics.waves.electronic.ElectronicStructure instance
        """
