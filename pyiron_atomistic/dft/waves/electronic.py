...
class ElectronicStructure(object):
    ...
    def get_dos(self, n_bins=100):
        """
        Gives a pyiron_atomistic.objects.waves.dos.Dos instance

        Args:
            n_bins (int): Number of histogram bins for the dos

        Returns:
            pyiron_atomistic.objects.waves.dos.Dos: Dos instance
...
class Kpoint(object):
    ...
    Attributes:
        ...
        bands (dict): Dict of pyiron_atomistic.objects.waves.settings.Band objects for each spin channel
    ...
    def add_band(self, eigenvalue, occupancy, spin):
        """
        Add a pyiron_atomistic.objects.waves.core.Band instance
