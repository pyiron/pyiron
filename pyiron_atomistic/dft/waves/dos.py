...
class Dos(object):
    ...
    Args:
        ...
        es_obj: The pyiron_atomistic.objects.waves.core.ElectronicStructure instance for which the DOS has to be computed
    ...
    def get_spin_resolved_dos(self, spin_indices):
        ...
        pyiron_atomistic.objects.waves.ElectronicStructure instance.
