...
from pyiron_atomistic.vasp.structure import write_poscar
...
class VolumetricData(object):
    ...
    def atoms(self):
        ...
        Returns:
            pyiron_atomistic.atomistics.structure.Atoms: The structure associated with the data
    ...
    def spherical_average_potential(self, structure, spherical_center, rad=2, fwhm=0.529177):
        ...
        Args:
            structure (pyiron_atomistic.atomistics.structure.Atoms): Input structure
