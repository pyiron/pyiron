...
import warnings
import seekpath
from pyiron_atomistic.atomistics.structure.atom import Atom, ase_to_pyiron as ase_to_pyiron_atom
from pyiron_atomistic.atomistics.structure.neighbors import Neighbors, Tree
from pyiron_atomistic.atomistics.structure._visualize import Visualize
from pyiron_atomistic.atomistics.structure.analyse import Analyse
from pyiron_atomistic.atomistics.structure.sparse_list import SparseArray, SparseList
from pyiron_atomistic.atomistics.structure.periodic_table import (
    PeriodicTable,
    ChemicalElement
)
...
class Atoms(ASEAtoms):
    ...
    def analyse_phonopy_equivalent_atoms(self):
        from pyiron_atomistic.atomistics.structure.phonopy import analyse_phonopy_equivalent_atoms
    ...
    def extend(self, other):
        ...
        Args:
            other (pyiron_atomistic.atomistics.structure.atoms.Atoms/ase.atoms.Atoms): Structure to append
...
def pyiron_to_ase(pyiron_obj):
    try:
        from pyiron_atomistic.atomistics.structure.pyironase import ASEAtoms
    except ImportError:
        raise ValueError("ASE package not yet installed")
