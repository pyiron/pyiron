...
from pyiron_atomistic.atomistics.structure.sparse_list import SparseArrayElement
...
class Atom(ASEAtom, SparseArrayElement):
    ...
    Args:
        symbol (str/pyiron_atomistic.atomistics.structure.periodic_table.ChemcicalElement): Symbol or elecment object
