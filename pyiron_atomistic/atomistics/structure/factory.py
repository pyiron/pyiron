...
import numpy as np
from pyiron_atomistic.atomistics.structure.pyironase import publication as publication_ase
from pyiron_atomistic.atomistics.structure.atoms import CrystalStructure, ase_to_pyiron, Atoms
...
class StructureFactory(PyironFactory):
    def ase_read(self, *args, **kwargs):
        """
        Returns a ASE's read result, wrapped as a `pyiron_atomistic.atomstic.structure.atoms.Atoms` object.
    ...
    def surface(
        ...
        Returns:
            pyiron_atomistic.atomistics.structure.atoms.Atoms instance: Required surface
    ...
    def surface_hkl(lattice, hkl, layers, vacuum=1.0, center=False, pbc=True):
        ...
        Args:
            lattice (pyiron_atomistic.atomistics.structure.atoms.Atoms/str): bulk Atoms
