...
from pyiron_atomistic.atomistics.structure.phonopy import publication as phonopy_publication
...
class PhonopyJobGenerator(JobGenerator):
    ...
    def _restore_magmoms(self, structure):
        ...
        Returns:
            structure (pyiron_atomistic.atomistics.structure.atoms): output structure with magnetic moments
        """
