...
class LammpsControl(GenericParameters):
    ...
    def calc_minimize(
        ...
        """
        # This docstring is a source for the calc_minimize method in pyiron_atomistic.lammps.base.LammpsBase.calc_minimize and
        # pyiron_atomistic.lammps.interactive.LammpsInteractive.calc_minimize -- Please ensure that changes to signature or
