...
from pyiron_atomistic.lammps.base import LammpsBase
from pyiron_atomistic.lammps.structure import UnfoldingPrism
...
class LammpsInteractive(LammpsBase, GenericInteractive):
    ...
    def interactive_cells_setter(self, cell):
        ...
        if is_scaled:
            warnings.warn('set_relative() is deprecated as of 2020-02-26. It is not guaranteed from pyiron_atomistic vers. 0.3')
