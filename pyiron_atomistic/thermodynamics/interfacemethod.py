...
"""
pyiron_atomistic based implementation of the coexistence method. Currently this functionality is primarly used as part
...
def freeze_one_half(basis):
    ...
    Args:
        basis (pyiron_atomistic.structure.atoms.Atoms): Atomistic structure object

    Returns:
        pyiron_atomistic.structure.atoms.Atoms: Atomistic structure object with half of the atoms fixed
    """
...
def create_job_template(job_name, structure, project_parameter):
    ...
    Args:
        ...
        structure (pyiron_atomistic.structure.atoms.Atoms): Atomistic Structure object to be set to the job as input sturcture
...
def npt_solid(temperature, basis, project_parameter, timestep=1.0):
    ...
    Args:
        temperature (float): Temperature of the Molecular dynamics calculation
        basis (pyiron_atomistic.structure.atoms.Atoms): Atomistic Structure object to be set to the job as input sturcture
        project_parameter (dict): Dictionary with the project parameters
...
def check_diamond(structure):
    ...
    Args:
        structure (pyiron_atomistic.structure.atoms.Atoms): Atomistic Structure object to check
...
def analyse_structure(structure, mode="total", diamond=False):
    ...
    Args:
        structure (pyiron_atomistic.structure.atoms.Atoms): The structure to analyze.
