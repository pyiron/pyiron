...
class SphinxBase(GenericDFTJob):
    ...
    def write_input(self, file_name="input.sx"):
        """
        ...
        Args:
            file_name (str): file to which input will be
                written (usually should not change from
                input.sx, since this is what SPHInX looks for
                by default)
        """
