...
class Atoms(object):
    ...
    def analyse_pyscal_steinhardt_parameter(atoms, cutoff=3.5, n_clusters=2):
        from pyiron.atomistics.structure.pyscal import get_steinhardt_parameter_structure
        return get_steinhardt_parameter_structure(structure=atoms, cutoff=cutoff, n_clusters=n_clusters)
