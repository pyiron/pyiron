...
exclude_patterns = ['_build', 'old', '**.ipynb_checkpoints', '**/tests']
...
modindex_common_prefix = ['pyiron_vasp/pyiron_vasp', 'pyiron_base', 'pyiron_lammps',
                          'pyiron', 'pyiron_dft', 'pyiron_atomistics', 'pyiron_example_job']
...
# of the sidebar.
html_logo = "_static/pyiron-logo-588x588.png"
...
man_pages = [
    ('index', 'pyiron', u'pyiron Documentation',
     [u'Joerg Neugebauer'], 1)
]
...
texinfo_documents = [
  ('index', 'pyiron', u'pyiron Documentation',
   u'Joerg Neugebauer', 'pyiron', 'One line description of project.',
   'Miscellaneous'),
]
